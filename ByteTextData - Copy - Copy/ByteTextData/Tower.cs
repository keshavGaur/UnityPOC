...
public class Tower : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (GameObject got in gots)
        {
            ...
            got.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        }
    ...
    IEnumerator initThings()
    {
        ...
        {
            //http://localhost:8080/projects/unity_tower_defence/newbuild
            //file:///C:/Users/tft/Desktop/CGame/AssetBundles/Windows/newbuild
            //WWW x = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/newbuild");
            //yield return x;
            if (AssetBundleScene.myHashtable.Count == 0)
            {
                yield return new WaitUntil(() => AssetBundleScene.myHashtable.Count != 0);
            }
            Cmanager.GetComponent<attachTower>().towerAssets = (AssetBundle)AssetBundleScene.myHashtable["newbuild"];
        }
      ...
      //  if (xx != null) Debug.Log("xx Not NULL XXXXXXXXXXXXXXXXX");
        ...
        StartCoroutine("imagevala");

        //Debug.Log("1");
        buildingsring = Sprite.Create(tex, new Rect(0, 0, tex.width, tex.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite bowmanIcon = Sprite.Create(tex2, new Rect(0, 0, tex2.width, tex2.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite ballistaIcon = Sprite.Create(tex5, new Rect(0, 0, tex5.width, tex5.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite barracksIcon = Sprite.Create(tex3, new Rect(0, 0, tex3.width, tex3.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite magicIcon = Sprite.Create(tex1, new Rect(0, 0, tex1.width, tex1.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite mortarIcon = Sprite.Create(tex4, new Rect(0, 0, tex4.width, tex4.height), new Vector2(0.5f, 0.5f), 100.0f);
        Sprite priceImageIcon = Sprite.Create(tex6, new Rect(0, 0, tex6.width, tex6.height), new Vector2(0.5f, 0.5f), 100.0f);
        //Debug.Log("2");
        xx.transform.Find("BG").GetComponent<Image>().sprite = buildingsring;
        xx.transform.Find("Bowman").transform.Find("Icon").GetComponent<Image>().sprite = bowmanIcon;
        xx.transform.Find("Magic").transform.Find("Icon").GetComponent<Image>().sprite = magicIcon;
        xx.transform.Find("Barrack").transform.Find("Icon").GetComponent<Image>().sprite = barracksIcon;
        xx.transform.Find("Mortar").transform.Find("Icon").GetComponent<Image>().sprite = mortarIcon;
        xx.transform.Find("Ballista").transform.Find("Icon").GetComponent<Image>().sprite = ballistaIcon;
        xx.transform.Find("Bowman").transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;
        xx.transform.Find("Magic").transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;
        xx.transform.Find("Barrack").transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;
        xx.transform.Find("Mortar").transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;
        xx.transform.Find("Ballista").transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;


        xx.transform.Find("Bowman").transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "5";
        xx.transform.Find("Magic").transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "6";
        xx.transform.Find("Barrack").transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "4";
        xx.transform.Find("Mortar").transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "10";
        xx.transform.Find("Ballista").transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "15";

        xx.transform.Find("Bowman").transform.Find("Price").transform.Find("Text").GetComponent<Text>().font = imagefont;
        xx.transform.Find("Magic").transform.Find("Price").transform.Find("Text").GetComponent<Text>().font = imagefont;
        xx.transform.Find("Barrack").transform.Find("Price").transform.Find("Text").GetComponent<Text>().font = imagefont;
        xx.transform.Find("Mortar").transform.Find("Price").transform.Find("Text").GetComponent<Text>().font = imagefont;
        xx.transform.Find("Ballista").transform.Find("Price").transform.Find("Text").GetComponent<Text>().font = imagefont;
    ...
    IEnumerator imagevala()
    {
       // Debug.Log("In image download part ");
        ...
        {
            //file:///C:/Users/tft/Desktop/cGame%20POC/AssetBundles/Windows/ring2
            //WWW TowerImageswww = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/ring2");
            //yield return TowerImageswww;
            if (AssetBundleScene.myHashtable.Count == 0)
            {
                yield return new WaitUntil(() => AssetBundleScene.myHashtable.Count != 0);
            }
            Cmanager.GetComponent<attachTower>().towerImagesAssets = (AssetBundle)AssetBundleScene.myHashtable["ring2"];
            tex = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("image.jpg") as Texture2D;
            tex1 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("magicImage.jpg") as Texture2D;
            tex2 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("bowmanImage.jpg") as Texture2D;
            tex3 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("barracksImage.jpg") as Texture2D;
            tex4 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("mortarImage.jpg") as Texture2D;
            tex5 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("ballistaImage.jpg") as Texture2D;
            tex6 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("priceImage.jpg") as Texture2D;
            imagefont = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("Irmologion.ttf") as Font;
    ...
    IEnumerator attachThings()
    {
        ...
        if (Cmanager.GetComponent<attachTower>().towerImagesAssets == null)
        {
            WWW TowerImageswww = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/towermakeoverprefabs");
            yield return TowerImageswww;
        ...
        */
        ...
        {
            Cmanager = GameObject.Find("CManager");
            //Debug.Log("cmanager is null");
        }
        if (!Cmanager.GetComponent<attachTower>()) Cmanager.AddComponent<attachTower>();
        if (Cmanager.GetComponent<attachTower>().towerprefabAssets == null)
        {
            //  Debug.Log("DOWNLOADING STUFF");
            //
            //file:///C:/Users/tft/Desktop/cGame%20POC/AssetBundles/Windows/towerprefab
            //WWW TowerPrefabs = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/towerprefab");
            //yield return TowerPrefabs;
            if (AssetBundleScene.myHashtable.Count == 0)
            {
                yield return new WaitUntil(() => AssetBundleScene.myHashtable.Count != 0);
            }
            Cmanager.GetComponent<attachTower>().towerprefabAssets =(AssetBundle)AssetBundleScene.myHashtable["towerprefab"];
            GameObject[] gos = GameObject.FindGameObjectsWithTag("Tower");

            foreach (GameObject G in gos)
            {
                G.GetComponent<Tower>().towerprefabAsset = (AssetBundle)AssetBundleScene.myHashtable["towerprefab"];
            }
            towerprefabAsset = (AssetBundle)AssetBundleScene.myHashtable["towerprefab"];
        }
        ...
        BowmanL1.transform.Find("Body").GetComponent<SpriteRenderer>().sortingOrder = 150;
        BowmanL1.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        ...
        if (!BowmanL1.GetComponent<Tower>())
        {
            ...
            {
                //file:///C:/Users/tft/Desktop/NewTD2D/AssetBundles/Windows/buildingtreechildprefabs
                //WWW buildTree = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/buildingtreechildprefabs");
                //yield return buildTree;
                if (AssetBundleScene.myHashtable.Count == 0)
                {
                    yield return new WaitUntil(() => AssetBundleScene.myHashtable.Count != 0);
                }
                Cmanager.GetComponent<attachTower>().buildTreeAssetS = (AssetBundle)AssetBundleScene.myHashtable["buildingtreechildprefabs"];
        ...
        MagicL1.transform.Find("Body").GetComponent<SpriteRenderer>().sortingOrder = 150;
        MagicL1.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        ...
        BarracksL1.transform.Find("Body").GetComponent<SpriteRenderer>().sortingOrder = 150;
        BarracksL1.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        ...
        if (!BarracksL1.GetComponent<DefendersSpawner>())
        {
            ...
            //
            //file:///C:/Users/tft/Desktop/NewTD2D/AssetBundles/Windows/defenderprefab
            //WWW defendprefabwww = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/defenderprefab");
            //yield return defendprefabwww;
            if (AssetBundleScene.myHashtable.Count == 0)
            {
                yield return new WaitUntil(() => AssetBundleScene.myHashtable.Count != 0);
            }
            Cmanager.GetComponent<attachTower>().defenderPrefab = (AssetBundle)AssetBundleScene.myHashtable["defenderprefab"];
        ...
        MortarL1.transform.Find("Body").GetComponent<SpriteRenderer>().sortingOrder = 150;
        MortarL1.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        ...
        BallistaL1.transform.Find("Body").GetComponent<SpriteRenderer>().sortingOrder = 150;
        BallistaL1.transform.Find("Floor").GetComponent<SpriteRenderer>().sortingOrder = -1;
        ...
        if (!BallistaL1.GetComponent<Tower>())
        {
           ...
           /*
            Texture2D texture = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("image.jpg") as Texture2D;
            buildingsring = Sprite.Create(texture, new Rect(0, 0, texture.width, texture.height), new Vector2(0.5f, 0.5f), 100.0f);
            //Texture2D texture2 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("ballistaImage.jpg") as Texture2D;
            //Sprite ballistaIcon = Sprite.Create(texture2, new Rect(0, 0, texture2.width, texture2.height), new Vector2(0.5f, 0.5f), 100.0f);
            tex6 = Cmanager.GetComponent<attachTower>().towerImagesAssets.LoadAsset("priceImage.jpg") as Texture2D;
            Sprite priceImageIcon = Sprite.Create(tex6, new Rect(0, 0, tex6.width, tex6.height), new Vector2(0.5f, 0.5f), 100.0f);
            
            

            ballistabuild.transform.Find("BG").GetComponent<Image>().sprite = buildingsring;
           // ballistabuild.transform.Find("Icon").GetComponent<Image>().sprite = ballistaIcon;
            //ballistabuild.transform.Find("Price").GetComponent<Image>().sprite = priceImageIcon;
            */
           // ballistabuild.transform.Find("Price").transform.Find("Text").GetComponent<Text>().text = "20";
    ...
    IEnumerator addBallistaArrow(GameObject game)
    {
        ...
        {
            yield return new WaitUntil(() => Cmanager.GetComponent<attachTower>().ArrowsAssets != null);
        }
        if (Cmanager.GetComponent<attachTower>().ExplosionAssets == null)
        {
            ...
            //WWW explosionswww = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/explosionall");
    ...
    IEnumerator addBowmanArrow(GameObject game)
    {
     //   Debug.Log("In addBowmanArrow");
        ...
        if (Cmanager.GetComponent<attachTower>().ArrowsAssets == null)
        {
           //  Debug.Log("null in addBowmanArrow");
            //http://localhost:8080/projects/unity_tower_defence/
            //file:///C:/Users/tft/Desktop/NewTD2D/AssetBundles/Windows/arrowsforall
            //WWW arrowswww = new WWW("http://203.110.85.165:9999/unity_tower_defence_Android/arrowsforall");
