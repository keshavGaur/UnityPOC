...
public class AiBehavior : MonoBehaviour
{
    ...
    {
        //if (other == null) Debug.Log("Other is null in AIBEHAVIOR");
       // if (my == null) Debug.Log("Other is null in AIBEHAVIOR");
        //if (trigger == null) Debug.Log("Other is null in AIBEHAVIOR");
       // Debug.Log("IN ONTRIGGER OF AIBEHAVIOR");
        //Debug.Log("OnTrigger OF  AiBehavior ");
       // if (currentState == null)
       // {
           // Debug.Log("Current sate is null");
       // }
       // Debug.Log(currentState + ": THIS IS CIRRENT STATE");
