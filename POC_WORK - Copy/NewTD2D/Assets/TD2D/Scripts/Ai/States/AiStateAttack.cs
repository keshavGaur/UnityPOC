...
public class AiStateAttack : AiState
{
    ...
    public override void Awake()
    {
        ...
        else Debug.Log(meleeAttack + " meleeAttack is not null in AiStateAttack");
        rangedAttack = GetComponentInChildren<AttackRanged>() as IAttack;
        if (rangedAttack == null) { Debug.Log("rangedAttack is null in AiStateAttack"); }
        else Debug.Log(rangedAttack+ "rangedAttack is not null in AiStateAttack");
