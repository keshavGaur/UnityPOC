...
public class AiState : MonoBehaviour
{
	...
	public virtual bool OnTrigger(Trigger trigger, Collider2D my, Collider2D other)
	{
        ...
        //Debug.Log(specificTransactions[0].trigger +"   trigger +  newstate"+ specificTransactions[0].newState + ": specificTransactions IMPPORTANT");
		...
		{
            Debug.Log(trigger + ": this is trigger" + transaction.trigger + "This is Transactions.trigger");
